<div class="col-lg-9">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            <div class="navbar-nav mr-auto py-0">
                ...
                <div class="nav-item dropdown mobile-only">
                    ...
                    <div class="dropdown-menu rounded-0 m-0" id="categoryDropdown">
        ...
        fetch('/categories')
            ...
            .then(categories => {
                ...
                categories.forEach(category => {
                    ...
                    categoryLink.href = `/category/${category.cat_name}`;
                    categoryLink.className = 'dropdown-item';
                    categoryLink.textContent = category.cat_name;
   ...
   <style>
    /* By default, hide the category dropdown on larger screens */
.mobile-only {
    display: none;
}

/* Show the category dropdown only on mobile screens (max-width 991px for Bootstrap) */
