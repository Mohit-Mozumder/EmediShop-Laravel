    ...
    <div class="container" id="mainDiv">
        <div class="row justify-content-center">
            <div class="col-md-12 my-5 card p-4">
                <h4><small>Manage Orders</small></h4>
                <div>
                    <a href="{{route('vendor.new.orders')}}" type="button" class="btn btn-primary position-relative">
                        New Order Requests
      ...
      $data = [
        ...
        'orderDate' => $item->created_at->format('d/m/Y'),
                        ...
                        <tr>
                            ...
                            {{-- <td><img style="width: 80px" src="{{url('images/products/'.$item->image)}}" alt=""></td> --}}
                            ...
                            <td>
                              ...
                              <form action="{{ route('vendor.order.status') }}" method="POST">
                                  ...
                                  <select class="form-select form-control bg-dark text-light statusChange" name="payment_status" aria-label="Payment status" style="width: 165px; font-size: 12px">
