...
use App\Http\Controllers\Admin\AdminManageVendor;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth:admin', 'PreventBackHistory'])->group(function () {
        ...
        // For Vendor or Admin to Manage Orders
        Route::get('/manage_orders/{vendor_id?}', [AdminManageVendor::class, 'ManageOrders'])->name('manage.orders');
        Route::get('/new_orders/{vendor_id?}', [AdminManageVendor::class, 'newOrders'])->name('new.orders');
        Route::post('/order_status', [AdminManageVendor::class, 'orderStatus'])->name('order.status');
        Route::post('/getOrderDetails', [AdminManageVendor::class, 'getOrderDetails']);
        //categories
        ...
        //delete vendor
        Route::get('/delete-vendor/{vendor_id}', [ManageVendorsController::class, 'deleteVendor'])->name('delete.vendor');
        //delete user
